...
private Q_SLOTS:
    ...
    void testRelativePositionHRelativeVAbsolute()
    {
        ...
        KChart::Measure mHoriz(horizPerMille, KChartEnums::MeasureCalculationModeRelative, KChartEnums::MeasureOrientationHorizontal);
        mHoriz.setReferenceArea(m_window);

        const qreal vertAbsolute = -50.0;
        KChart::Measure mVert(vertAbsolute, KChartEnums::MeasureCalculationModeAbsolute);
    ...
    void testRelativePositionHAbsoluteVRelative()
    {
        ...
        KChart::Measure mHoriz(horizAbsolute, KChartEnums::MeasureCalculationModeAbsolute);

        const qreal vertRelative = -50.0;
        KChart::Measure mVert(vertRelative, KChartEnums::MeasureCalculationModeRelative, KChartEnums::MeasureOrientationVertical);
